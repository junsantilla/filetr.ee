	...
	return (
		<section className="mx-auto w-full max-w-3xl px-4 py-16">
			...
			<p className="mt-6 text-base text-neutral-600 dark:text-neutral-300">
				By accessing or using Filetr.ee, you agree to these terms. If you do
			...
			<div className="mt-10 space-y-8">
				<section>
					...
					<ul className="mt-3 list-disc space-y-2 pl-5 text-neutral-600 dark:text-neutral-300">
						<li>The content is provided for informational purposes only.</li>
						<li>You may view, share, and reference the content.</li>
						<li>
							You agree not to disrupt the site or attempt to gain unauthorized
				...
				<section>
					...
					<p className="mt-3 text-neutral-600 dark:text-neutral-300">
						The site uses third-party services such as analytics and GitHub
						comments. Your use of those services is governed by their own
						terms and policies.
					</p>
				</section>
				...
				<section>
					...
					<p className="mt-3 text-neutral-600 dark:text-neutral-300">
						...
						do not guarantee accuracy, completeness, or availability.
					</p>
				</section>
				...
				<section>
					...
					<p className="mt-3 text-neutral-600 dark:text-neutral-300">
						To the fullest extent permitted by law, Filetr.ee is not liable
